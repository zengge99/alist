...
func (d *AliyundriveShare2Pan115) refreshToken() error {
...
func (d *AliyundriveShare2Pan115) getShareToken() error {
	data := base.Json{
		"share_id": d.ShareId,
	}
	if d.SharePwd != "" {
...
func (d *AliyundriveShare2Pan115) request(url, method string, callback base.ReqCallback) ([]byte, error) {
        var e ErrorResp
...
func (d *AliyundriveShare2Pan115) getFiles(fileId string) ([]File, error) {
	files := make([]File, 0)
	data := base.Json{
...
func (d *AliyundriveShare2Pan115) refreshTokenOpen() error {
...
func (d *AliyundriveShare2Pan115) requestOpen(uri, method string, callback base.ReqCallback, retry ...bool) ([]byte, error) {
